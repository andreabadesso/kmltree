...
f={visitFunction:function(b,d){return d},refreshWithState:true,bustCache:false,restoreState:false,supportItemIcon:false,loadingMsg:"Loading data",setExtent:false,displayDocumentRoot:"auto"};return function(b){var d={},h=0,o={};d.lookupTable=o;d.kmlObject=null;b=jQuery.extend({},f,b);var m=b.gex.pluginInstance,r=false,t={};parseFloat(m.getPluginVersion())<5.2&&alert("kmltree requires a google earth plugin version >= 5.2");if(!b.url||!b.gex||!b.element||!b.mapElement)throw"kmltree requires options url, gex, mapElement & element";
